...
<!-- Generated from public repository metadata, README files, manifests, and repository languages on 2026-06-13. -->
...
<p>
  ...
  <img alt="React" src="https://img.shields.io/badge/React-UI-61DAFB?style=flat-square&logo=react&logoColor=111111">
</p>
...
pie showData
  title Output Types
  "Static analysis / code parsing" : 10
  "Windows GUI / CLI tools" : 9
...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top"><a href="https://github.com/SSsan-00/Razor-Indent-Formatter"><strong>Razor-Indent-Formatter</strong></a><br>Razor(.cshtml)ファイルのインデントを整形するツール<br><br><strong>Skills</strong><br><img alt="TypeScript" src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&amp;logo=typescript&amp;logoColor=white"> <img alt="HTML" src="https://img.shields.io/badge/HTML-DC2626?style=flat-square&amp;logo=html5&amp;logoColor=white"> <img alt="Vite" src="https://img.shields.io/badge/Vite-7C3AED?style=flat-square&amp;logo=vite&amp;logoColor=white"><br><br><strong>Project Type</strong><br><img alt="Single HTML / browser apps" src="https://img.shields.io/badge/Browser_apps-0E7490?style=flat-square"> <img alt="Static analysis / code parsing" src="https://img.shields.io/badge/Static_analysis-7C3AED?style=flat-square"></td>
  </tr>
  </tbody>
</table>
...
| [money-app](https://github.com/SSsan-00/money-app) | HTML, Java, CLI, TDD | Javaでテスト駆動開発 |
...
| Code analysis | Roslyn, SemanticModel, ScriptDom, PostgreSQL, SQL |
