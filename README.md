...
<!-- Generated from public repository metadata, README files, manifests, and repository languages on 2026-06-24. -->
...
| [TableAndColumnListMaker](https://github.com/SSsan-00/TableAndColumnListMaker) | VBA, Excel, XLSX | Excel VBA macro for recursively listing table and column information from target workbooks. |
